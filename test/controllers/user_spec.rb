...
RSpec.describe App do
  ...
  it 'adds user user to the database' do
  ...
  it 'displays user sign up page' do
    get '/user/signup'
    expect(last_response).to be_ok
  ...
  it 'displays error message when username is empty' do
    post '/user/signup', params = {
      user: {
        username: '  ',
        email: 'naruto@email.com',
  ...
  it 'displays error message when password is not alphanumeric' do
    post '/user/signup', params = {
      user: {
        username: 'test',
  ...
  it 'displays error message when password is empty' do
    post '/user/signup', params = {
      user: {
        username: 'test',
        email: 'test@email.com',
  ...
  it 'displays error message when email is empty' do
    post '/user/signup', params = {
      user: {
        username: 'test',
        email: '',
  ...
  it 'displays user login page' do
    get '/user/login'
    expect(last_response).to be_ok
    expect(last_response.body).to include('username')
    expect(last_response.body).to include('password')
